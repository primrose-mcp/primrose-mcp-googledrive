 ...
 *
 * Custom error classes and error handling helpers for Google Drive API.
 */

/**
 * Base Google Drive API error
 */
 ...
 */
export class RateLimitError extends GoogleDriveApiError {
 ...
 */
export class AuthenticationError extends GoogleDriveApiError {
 ...
 * Not found error
 */
export class NotFoundError extends GoogleDriveApiError {
 ...
 * Validation error
 */
export class ValidationError extends GoogleDriveApiError {
 ...
 */
export class ForbiddenError extends GoogleDriveApiError {
  constructor(message: string) {
